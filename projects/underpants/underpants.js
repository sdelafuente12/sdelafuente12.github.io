...
*   _.first(["a", "b", "c"], 2) -> ["a", "b"]
*/
// function takes two parameters. array & numbers. 
// if array !== 
...
/*_.filter = function(array, test){
    const result = _.filter(array, function(element, index, function){
        return !test(element, i, collection);
    });
};
...
_.partition = function(array, func){
  ...
  _.each(array, function(element, index, array){
    ...
    //   for(var i = 0; i < array.length; i++){
    //       if((func(array[i], i, array) === true){
    //           newArray[0].push(func[i]);
    //   } if((func(array[i]), i, array) === false) {
    //         newArray[1].push(func[i]);
    //   }
...
// return false; 
    ...
    //create a for loop to access the elements
    //call function (current element, index, collection)
    //if collection is object 
    //call function (current value, current key, collection)
    //if the return of calling the function is true FOR AT LEAST ONE ELEMENT
    //return true 
    //if its false FOR ALL ELEMENTS return false 
...
//iterate over every element in a collection
//perform a function on each element
//the function has parameters PREVIOUS RESULT, ELEMENT, INDEX
//assign var previousResult = function return value
//on the first iterati
